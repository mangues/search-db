...
@Component
public class DictSearchHandler {
    @Autowired
    private ObjectMapper mapper;

    public Object wrap(Object obj,Class aClass) throws IllegalAccessException, IOException, ClassNotFoundException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        ...
        for (Map.Entry<String, List<Object>> map : variableMap.entrySet()) {
            ...
            if (!ObjectUtils.isEmpty(value)) {
                ...
                if (stringBuilder != null) {
                    ...
                    List<Map<String, Object>> resultMapList = ReflectUtil.sqlRunner(stringBuilder.toString());
    ...
    //                 1:  dictId
    //}
    private  Map<String,Map<Integer,StringBuilder>> getRunSqlMap(Field[] fieldList) {
    ...
    //}
    private void field2Map(Object obj, Field[] fieldList,Map<String,List<Object>> variableMap) throws IllegalAccessException {
        //遍历所有变量
        for (Field field : fieldList) {
            boolean annotationPresent = field.isAnnotationPresent(DictParam.class);
            if (annotationPresent) {
    ...
    //值变对象
    //变量名，变量值 -> 变量值对应的对象
    private Map variable2Map(Object obj, Field[] fieldList,Map<String,Map<Object, List<Map<String, Object>>>> variableMap) throws IOException, IllegalAccessException {
                ...
                if (object != null) {
                    ...
                    if (objectListMap!=null){
                        ...
                        if (maps!=null&&maps.size()>0) {
                            ...
                            jsonObject.put(name+"Dict",stringObjectMap);
                        }
                    }
                }
            }
